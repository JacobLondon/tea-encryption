...
HD_PWD='C:/Users/jelon/Documents/Workspaces/VHDL/tea-encryption/src/hardware/vivado/XTea.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TeaTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TeaTop.tcl

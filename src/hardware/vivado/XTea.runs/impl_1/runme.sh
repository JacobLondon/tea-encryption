...
HD_PWD='C:/Users/jelon/Documents/Workspaces/VHDL/tea-encryption/src/hardware/vivado/XTea.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TeaTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TeaTop.tcl -notrace

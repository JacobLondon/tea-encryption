...
#set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33} [get_ports {index[4]}]

#set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {index[5]}]

#set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {index[6]}]

#set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {index[7]}]
